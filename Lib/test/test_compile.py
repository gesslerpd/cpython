...
class TestSpecifics(unittest.TestCase):
    ...
    def test_empty_set_unpack_literal_bytecode_optimization(self):
        cases = {
            ...
            # Removing the empty unpack first keeps BUILD_SET eligible for
            # constant folding of the three preceding constants.
            '{1, 2, 3, *()}': [
                ('RESUME', 0),
                ('BUILD_SET', 0),
    ...
    def test_empty_tuple_unpack_list_and_tuple_bytecode_optimization(self):
        cases = {
            # optimized cases
            '[*()]': [
                ('RESUME', 0),
            ...
            # Removing the empty unpack first keeps BUILD_LIST eligible for
            # constant folding of the three preceding constants.
            '[1, 2, 3, *()]': [
                ('RESUME', 0),
                ('BUILD_LIST', 0),
